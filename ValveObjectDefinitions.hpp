...
QList<QList<QVariant>> valveConstructingParameters {
                ...
                {"FDV", 23, 8, 46, 47, 138, QVariant::fromValue(Valve::ValveNode::PROP_NODE)},
                {"LV", 18, 1, 36, 37, 131, QVariant::fromValue(Valve::ValveNode::PROP_NODE)},
                {"FV", 21, 5, 42, 43, 135, QVariant::fromValue(Valve::ValveNode::PROP_NODE)},
                {"LMV", 24, 4, 48, 49, 124, QVariant::fromValue(Valve::ValveNode::ENGINE_NODE)},
                {"FMV", 25, 3, 50, 51, 123, QVariant::fromValue(Valve::ValveNode::ENGINE_NODE)},
                {"IGN1", 26, 5, 52, 53, 125, QVariant::fromValue(Valve::ValveNode::ENGINE_NODE)},
                {"IGN2", 27, 7, 54, 55, 127, QVariant::fromValue(Valve::ValveNode::ENGINE_NODE)}
    };
